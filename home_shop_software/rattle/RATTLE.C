/* RATTLE.C   M. W. Klotz  11/99

Lautard's method for approximating diameters
...
{
int i,j,k;
dbl stick,rattle,theta,beta,diff,diam;

/* -------------------------- initializations ------------------------------ */
textscreen ();
/* ------------------------------------------------------------------------- */

puts ("DIAMETER MEASUREMENT\n");

vin ("Measured stick/caliper distance",&stick,"lf",4.,"");
vin ("Rattle distance",&rattle,"lf",.2,"");
printf ("\n");

/* ECCENT.C   M. W. Klotz   11/98, 9/01

PACKING SIZING FOR MAKING ECCENTRICS IN A 3-JAW CHUCK

9/01:  Corrections pointed out by David Hoskins of Australia made.
...
root3=sqrt(3.);
puts ("THREE JAW ECCENTRIC PACKING CALCULATION\n");
vin ("Width of chuck jaws",&w,"lf",0.125,"in");
vin ("Diameter of workpiece",&d,"lf",1.5625,"in");
r=.5*d;
vin ("Required eccentric offset",&e,"lf",0.28125,"in");

if (e>(r+w)/root3)
{
puts ("Work will fall through unpacked jaws."); goto mexit;
}

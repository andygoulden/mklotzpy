/* MRADIUS.C   M. W. Klotz   3/02

How to measure the radius of curvature of a part
...
vin ("Diameter of rollers (d)",&d,"lf",0.25,"");
vin ("Measurement across rollers (m)",&m,"lf",2.0,"");
vin ("Gap (g)",&g,"lf",0.1,"");

r=0.5*d; w=0.5*m-r;
R=((r-g)*(r-g)+w*w-r*r)/(2*(d-g));

printf ("\nRadius of curvature = %.4lf\n",R);

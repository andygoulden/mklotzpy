/* QBELT.C   M. W. Klotz   3/00

Calculate belt length for two pulleys
...
print;
vin ("Diameter of smaller pulley",&d1,"lf",2.,"");
vin ("Diameter of larger pulley",&d2,"lf",6.,"");
vin ("Separation between pulley centers",&sep,"lf",6.,"");
if (d1 > d2) {span=d1; d1=d2; d2=span;}

r1=0.5*d1; r2=0.5*d2; eps=r2-r1; phi=ASN(eps/sep); theta=2*phi;
beta1=PI-theta; beta2=PI+theta;
wrap1=r1*beta1; wrap2=r2*beta2;
span=sqrt(sep*sep-eps*eps);

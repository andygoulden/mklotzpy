/* SPEED.C   M. W. Klotz  11/98, 4/05

Cutting speed as function of material and diameter
...
char dfile[]="SPEED.DAT";	/* data file */
...
vin ("Diameter",&d,"lf",1.0,"in");
c=12/PI; low=c*lo[nm]/d; high=c*hi[nm]/d;

printf ("\nFor %s and diameter %.4lf in:\n",name[nm],d);
printf ("Recommended rpm between %.0lf and %.0lf\n",low,high);

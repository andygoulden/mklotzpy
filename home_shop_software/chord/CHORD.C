/* CHORD.C   M. W. Klotz   2/00

Calculate chord length for stepping off circle to input number of divisions
...
{
int i,j,k;
dbl nd,diam,angle,chord;

/* -------------------------- initializations ------------------------------ */
/* ------------------------------------------------------------------------- */

puts ("CHORD LENGTH CALCULATION\n");

vin ("Number of divisions",&nd,"lf",5.,"");
vin ("Diameter of circle",&diam,"lf",1.,"");

angle=360/nd;
chord=diam*SIND(.5*angle);

printf ("Chord length = %.4lf\n",chord);

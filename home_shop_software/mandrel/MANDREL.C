...
puts ("Kozo Hiraoka's SPRING WINDING MANDREL DIAMETER CALCULATION\n");

vin ("Wire type: music wire [0] or phosphorus bronze (1)",&wt,"lf",0.,"");
if (wt != 1) wt=0;

vin ("Wire diameter",&dw,"lf",0.040,"in");
vin ("Spring inside diameter",&id,"lf",0.203,"in");

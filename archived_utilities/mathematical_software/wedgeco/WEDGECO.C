/* WEDGECO.C   M. W. Klotz   8/05

Compute volume of a wedge cut from a cone by a plane parallel to cone's axis.
...
dbl dcone;		// cone base diameter
dbl rcone;		// cone base radius
dbl H;			// height of wedge
dbl sagitta;		// sagitta of wedge base
dbl vcone;		// volume of complete cone
dbl vwedge;		// volume of wedge
...
puts ("\nCOMPUTE VOLUME OF A CONICAL WEDGE\n");

vin ("Cone base diameter",&dcone,"lf",2.,"");
rcone=0.5*dcone;
vin ("Height of cone",&H,"lf",10.,"");
vcone=PI*rcone*rcone*H/3.;
agin:
vin ("Sagitta of wedge base",&sagitta,"lf",0.5,"");
if (sagitta > dcone || sagitta <= 0.)
{
beep;
...
vwedge=wedge(H,sagitta,rcone);

printf ("\nVolume of complete cone = %.4lf\n",vcone);
printf ("Volume of conical wedge = %.4lf\n",vwedge);
printf ("Ratio wedge volume/cone volume = %.4lf\n",vwedge/vcone);

/* CUSP.C   M. W. Klotz  10/02

Compute cusp height obtained with successive cuts using a ball end mill.
Written for Kevin Van de Velde (kevinv@cin.net)
...
vin ("Ball mill diameter",&b,"lf",0.25,"in");
vin ("Desired cusp height",&c,"lf",0.001,"in");
r=0.5*b;

d=2.*sqrt(2.*r*c-c*c);

printf ("Spacing between successive cuts = %.4lf in\n",d);

/* KNURL.C   M. W. Klotz   11/98

Workpiece diameter for perfect knurling
...
puts ("WORKPIECE DIAMETER FOR PERFECT KNURLING\n");

vin ("Diameter of knurl wheel",&dk,"lf",0.625,"in");
vin ("Number of teeth on knurl wheel",&nk,"d",40.,"");
vin ("Nominal diameter of workpiece",&d0,"lf",0.87,"in");
deltak=PI*dk/nk;
printf ("Spacing between knurl teeth = %.3lf in\n",deltak);
m=(int)floor(PI*d0/deltak);
printf ("Integer number of crests to make on workpiece = %d\n",m);
printf ("Required workpiece circumference = %.3lf in\n",m*deltak);
printf ("\nWORKPIECE DIAMETER FOR PERFECT KNURLING = %.3lf in",m*deltak/PI);

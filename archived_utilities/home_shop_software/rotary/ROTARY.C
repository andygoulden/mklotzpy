/* ROTARY.C   M. W. Klotz   4/99

Calculations for indexing on a rotary table
...
char ofile[]="ROTARY.OUT";	/* output file */
...
puts ("ROTARY TABLE CALCULATIONS\n");

if ((fp=fopen(ofile,"wt")) == NULL)
	{printf ("FAILED TO OPEN OUTPUT FILE: %s\n",ofile); quit;}

vin ("Number of divisions",&nd,"d",13.,"");

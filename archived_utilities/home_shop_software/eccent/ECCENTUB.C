/* ECCENTUB.C   M. W. Klotz   02/01

TUBE SIZE FOR TURNING TURNING OFFSET ECCENTRICS IN 3-JAW
...
puts ("TUBE SIZE FOR TURNING ECCENTRICS\n");
vin ("Diameter of parent stock",&D,"lf",1.0,"in");
vin ("Required eccentric offset",&e,"lf",0.1,"in");
R=0.5*D; r=R-e;
dtube=2.*sqrt(7.*R*R-9.*R*r+3.*r*r);
printf ("\nDiameter of required tube = %.4lf in\n",dtube);

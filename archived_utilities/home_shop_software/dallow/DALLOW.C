...
puts ("DRILL TIP ALLOWANCE COMPUTATION\n");

vin ("Included angle of drill tip",&theta,"lf",118.,"deg");
tz=TAND(0.5*theta);
vin ("Drill diameter",&dh,"lf",0.5,"in");
a=0.5*dh/tz;
printf ("\nAllowance for drill tip = %.4lf in\n",a);

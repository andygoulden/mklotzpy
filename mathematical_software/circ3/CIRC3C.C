/* CIRC3C.C   M. W. Klotz   4/08

Find radius of circle passing through three points given cartesian coordinates of points
...
puts ("Enter coordinates of points as specified below:\n");

vin ("point 1 - x",&x1,"lf",3.121,"");
vin ("point 1 - y",&y1,"lf",4.121,"");
vin ("point 2 - x",&x2,"lf",1.,"");
vin ("point 2 - y",&y2,"lf",5.,"");
vin ("point 3 - x",&x3,"lf",-1.121,"");
vin ("point 3 - y",&y3,"lf",4.121,"");


circ3 (x1,y1,x2,y2,x3,y3,&xc,&yc,&r);

printf ("\nradius of circle = %.4lf\n",r);
printf ("circle center coordinates (x,y) = (%.4lf, %.4lf)\n",xc,yc);
